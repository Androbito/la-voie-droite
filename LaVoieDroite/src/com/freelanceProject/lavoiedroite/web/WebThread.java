...
public class WebThread extends Thread {
	 ...
	 */
	public WebThread(String url, int methode, Map<String, String> params,
	...
	public void run() {
		...
		try {
			...
			if (connexionStatus(connectionManager) == true) {
				...
				getListener().onFinishWithParams(this.url, this.params,
						this.resultat);
			} else {
				throw WebException
	...
	private HttpResponse methodePost(HttpClient client, String url,
		...
		if (params != null) {
			...
			while (i.hasNext()) {
				...
				parametres.add(new BasicNameValuePair(element.getKey(), element
						.getValue()));
				Log.d("WebThread",
	...
	public static String connectSingle(String url)
